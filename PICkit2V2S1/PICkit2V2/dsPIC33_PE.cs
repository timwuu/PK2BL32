...
namespace PICkit2V2
{
    public class dsPIC33_PE : PICmicro
    {
        ...
        public override bool DownloadPE()
        {
            ...
            for (int row = 0; row < 16; row++)
            {
                ...
                for (int section = 0; section < 4; section++)
                {
                    ...
                    workaround = PE_Code[instruction - 4];
        ...
        public override bool PE_Write(int endOfBuffer, string saveText)
        {
            if (!PE_DownloadAndConnect())
            {
                return false;
        ...
        public override bool PE_Verify(string saveText)
        {
            if (!PE_DownloadAndConnect())
            {
                return false;
